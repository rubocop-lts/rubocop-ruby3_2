...
# rubocop-ruby3_2 Rakefile v7.0.0 - 2026-06-19
...
# rake install                                # Build and install rubocop-ruby3_2-1.0.0.gem in...
# rake install:local                          # Build and install rubocop-ruby3_2-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template rubocop-ruby3_2 against itse...
